...
(1, '123', '', 'PC', '', '', '', '', '', '', NULL, '', '', '', NULL, '0000-00-00', '2010-10-27 15:03:28', NULL, NULL, '');
...
(1, 1, '123', NULL, NULL, NULL, NULL, 'C', '', NULL, '', '', '', '', NULL, '', '', '', NULL, '0000-00-00', '2010-10-27 15:20:50', NULL, NULL, '', '');
...
(1, 1, '456', '', '', NULL, '', '', '', '', NULL, '', '', '', NULL, '0000-00-00', '2010-10-27 16:17:54', NULL, NULL, '', '', '');
...
(1, 1, 'test_depot', '', NULL, '', '', '', '', NULL, '', '', '', NULL, '0000-00-00', '2010-10-28 08:40:03', NULL, NULL, '', '', '');
...
(1, NULL, 1, 1, 1, 1, 1, 'root', 'root', 'ACTIVE', NULL, '2010-10-28 08:36:28', '', '', '', '', '', '', '', NULL, '', NULL, '', '', '');
...
, `homebase`.`h_Carrier_Number` AS `vau_homebase_code`
, `user`.`u_Company_ID` AS `vau_company_id`
, `company`.`c_Number` AS `vau_company_code`
, `depot`.`d_Name` AS `vau_depot_name`
, `parent_company`.`pc_Account_Number` AS `vau_parent_company_code`
FROM `user`
