...
class Driver_AjaxDriverHoursOfServiceController extends Zend_Controller_Action
{
    ...
    public function proceedHosAction()
    {
        ...
        $currentDriverHosList = Driver_Model_DriverHos::getList($Driver_ID,1);
        $currentDriverLrfwRecord = Driver_Model_DriverLrfw::getRecord($Driver_ID);
        ...
        $layout->setLayout('proceed-hos');

        $layout->driverId = $Driver_ID;
        $layout->currentDriverHoSList = $week;
        $layout->currentDriverLrfwRecord = $currentDriverLrfwRecord;
        echo $layout->render();
    }
